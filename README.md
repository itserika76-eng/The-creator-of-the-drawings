...
- ✅ Перенос с картинки: интегрирован CV-пайплайн, OCR рамки и улучшенная векторизация (LSD + Hough fallback + фильтрация ложных линий) для более похожего на исходник результата.
