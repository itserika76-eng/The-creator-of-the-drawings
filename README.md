...
- ✅ Перенос с картинки: интегрирован CV-пайплайн (поиск линий/окружностей), OCR рамки и векторизация линий изображения в CAD-сегменты.
...
Добавлен fallback: программа активирует окно КОМПАС и пошагово рисует геометрию через UI (инструмент «Отрезок») по сегментам изображения.
...
1. **Лучший вариант**: использовать нативный COM API конкретной версии КОМПАС (без UI-автоматизации) и фиксированные вызовы `Document2D`.
